...
- [x] **Step 1: Write the package manifest and tests**
...
- [x] **Step 2: Run the tests to verify the geometry API is absent**
...
- [x] **Step 4: Run the tests to verify the helper**
...
- [x] **Step 1: Implement `OverlayWindow`**
...
- [x] **Step 2: Implement `OverlayView`**
...
- [x] **Step 3: Implement `AppDelegate` and application entry point**
...
- [x] **Step 5: Commit the window implementation**
...
- [x] **Step 1: Add bundle metadata and packaging script**
...
- [x] **Step 3: Add user instructions**
...
- [x] **Step 4: Run launch and process smoke tests**
...
- [x] **Step 5: Verify persistence with a relaunch**
...
- [x] **Step 6: Commit the packaged deliverable**
...
- [x] **Step 2: Inspect the final bundle**
...
- [x] **Step 3: Report exact deliverables and any manual-only checks**
